...
dataset_path = "./datasets/normalized/hafez_norm.txt"
...
#     r"[آ-ی  ]"
# )  # This pattern matches all Farsi characters and spaces
# farsi_text = "".join(farsi_pattern.findall(corpus))
# chars = sorted(list(set(farsi_text)))
